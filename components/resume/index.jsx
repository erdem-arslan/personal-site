...
function Resume() {
    ...
    <div className='mt-6 ml-6'>
            <HeadTitle children="Resume"/>
            <SubTitle children="Education" icon={BsBook}/>

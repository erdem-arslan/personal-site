...
function index() {
  return (
<div className='backdrop-blur-blur-1 fixed lg:absolute bottom-0 left-1/2 transform -translate-x-1/2 lg:top-0 lg:right-0 w-full lg:w-3/5 bg-light-gray rounded-tr-3xl rounded-tl-3xl'>

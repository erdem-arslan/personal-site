...
import { AiOutlineMail, AiOutlinePhone, AiFillLinkedin,AiFillGithub, AiOutlineTwitter } from 'react-icons/ai'
...
function Sidebar() {
  return (
    <div className="w-[23%] bg-dark-gray h-screen border rounded-3xl border-light-gray flex flex-col justify-center items-center">
        ...
        <div className='mb-10'>
          <p className="py-2 px-3 text-white-2 text-sm bg-light-gray inline rounded-lg">Front End Developer</p>
        </div>

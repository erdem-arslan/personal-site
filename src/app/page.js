  ...
  return (
    <div className='w-full'>
      ...
      <div className="w-3/4 mx-auto py-16 flex justify-between">
        ...
        {/* CONTENT START */}
        <div className="w-[75%] bg-dark-gray h-full border rounded-3xl border-light-gray relative">

          {/* header start */}
          <div className='absolute top-0 right-0 w-3/5 bg-light-gray rounded-tr-3xl rounded-bl-3xl'>
            <ul className='flex justify-between'>
              <li className='py-5 px-4'>
                <Link href="/" className='text-white-2 font-links-1 font-semibold text-lg hover:text-white-3 transition'>About</Link>
              </li>
              <li className='py-5 px-4'>
                <Link href="/" className='text-white-2 font-links-1  font-semibold text-lg hover:text-white-3 transition'>Resume</Link>
              </li>
              <li className='py-5 px-4'>
                <Link href="/" className='text-white-2 font-links-1  font-semibold text-lg hover:text-white-3 transition'>Portfolio</Link>
              </li>
              <li className='py-5 px-4'>
                <Link href="/" className='text-white-2 font-links-1  font-semibold text-lg hover:text-white-3 transition'>Blog</Link>
              </li>
              <li className='py-5 px-4'>
                <Link href="/" className='text-white-2  font-links-1 font-semibold text-lg hover:text-white-3 transition'>Contact</Link>
              </li>
            </ul>
          </div>
          {/* header end */}
